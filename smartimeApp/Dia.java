...
public class Dia {
    ...
    public void asignarBloque(Scanner scan) {
        ...
        System.out.println("Ingrese hora inicial del bloque: (1° hora, luego minuto)");
        int[] horaIni = new int[2];
        int[] horaFin = new int[2];
        try {
            horaIni[0] = scan.nextInt();
            horaIni[1] = scan.nextInt();
            scan.nextLine();
            System.out.println("Ingrese hora final del bloque: (1° hora, luego minuto)");
            horaFin[0] = scan.nextInt();
            horaFin[1] = scan.nextInt();
            scan.nextLine();
        } catch (Exception e) {
    ...
    public void modificarDia(Scanner scan) {
        ...
        switch (opcion) {
            case 1: // Modificar un bloque
                ...
                System.out.println("Ingrese nueva hora inicial: (1° hora, luego minuto)");
                int[] horaIni = new int[2];
                int[] horaFin = new int[2];
                try {
                    horaIni[0] = scan.nextInt();
                    horaIni[1] = scan.nextInt();
                    scan.nextLine();
                    System.out.println("Ingrese nueva hora final: (1° hora, luego minuto)");
                    horaFin[0] = scan.nextInt();
                    horaFin[1] = scan.nextInt();
                    scan.nextLine();
                } catch (Exception e) {
